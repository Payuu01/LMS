...
$cid = $_GET['id'];
$sql = "select * from courses_tbl inner join category_tbl on category_tbl.m_category_id = courses_tbl.m_course_category where m_course_id='$cid'";
...
<section class="w3l-breadcrumb">
    <div class="breadcrumb-bg breadcrumb-bg-about py-5">
        <div class="container pt-lg-5 pt-3 p-lg-4 pb-3">
            <h2 class="title mt-5 pt-lg-5 pt-sm-3"><?php echo $data['m_category_title'] ?></h2>
    ...
    <div class="container py-lg-5 py-md-4 py-2">
        <div class="row">
            <div class="col-lg-6 align-self">
                ...
                <h3 class="title-big mx-0"><?php echo $data['m_course_title'] ?></h3>
                <p class="mt-lg-4 mt-3"><?php echo $data['m_course_desc'] ?></p>
                
            </div>
            <div class="col-lg-6 left-wthree-img mt-lg-0 mt-sm-5 mt-4">
                <img src="<?php echo "admin/upload/".$data['m_course_banner'] ?>" alt="Card image cap" class="img-fluid radius-image">
            </div>
        </div>
    </div>
</section>
